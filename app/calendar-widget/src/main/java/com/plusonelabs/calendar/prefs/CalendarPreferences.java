...
public class CalendarPreferences {
    ...
    public static final String PREF_EVENTS_START_DEFAULT = "0";
    public static final int PREF_EVENTS_START_TODAY = -1;
    ...
    public static final int PREF_PAST_EVENTS_BACKGROUND_COLOR_DEFAULT = 0x00f44336;
